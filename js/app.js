  ...
  function se({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      "custom" === s.type && s.renderCustom
        ? (a.html(s.renderCustom(e, c + 1, p)), i("paginationRender", a[0]))
    ...
    function u() {
      ...
      0 !== s.length &&
        ...
        t.clickable &&
          s.on("click", te(t.bulletClass), function (t) {
            t.preventDefault();
    ...
    function h() {
      ...
      s.removeClass(t.hiddenClass),
        ...
        t.clickable && s.off("click", te(t.bulletClass));
    }
    s("init", () => {
      u(), p(), c();
    }),
